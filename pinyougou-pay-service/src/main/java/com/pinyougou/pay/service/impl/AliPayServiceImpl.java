...
public class AliPayServiceImpl implements AliPayService {
    ...
    public Map createNative(String out_trade_no, String total_fee) {
        ...
        String body = "舞指仙境线下门店消费"+Double.valueOf(total_fee)/100+"元";
        ...
        GoodsDetail goods1 = GoodsDetail.newInstance(out_trade_no, "舞指仙境脚底按压", Long.valueOf(total_fee), 1);
        // 创建好一个商品后添加至商品明细列表
